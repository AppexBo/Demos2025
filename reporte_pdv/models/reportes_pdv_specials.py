...
class PosOrderLine(models.Model):
    ...
    #ya hay datos en este valor pero como string
    creado_en_rep = fields.Char(string='Creado en', compute='_compute_order_values', store=True)

    creado_en_repo = fields.Datetime(string='Creado en', compute='_compute_order_values', store=True)
    ...
    def _compute_order_values(self):
        for line in self:
            ...
            line.creado_en_repo = line.create_date
